...
class RecipientSelectionModal extends ConsumerWidget {
  const RecipientSelectionModal({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final recipients = ref.watch(recipientsProvider).value ?? [];
          ...
          if (recipients.isEmpty)
            ...
            ListView.separated(
              ...
              itemBuilder: (context, index) {
                ...
                final isSelected = recipient == selectedRecipient;

                return GestureDetector(
                  onTap: () {
                    ref.read(selectedRecipientProvider.notifier).state =
                        recipient;
