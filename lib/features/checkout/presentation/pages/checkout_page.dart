              ...
              children: [
                Expanded(
                  child: GestureDetector(
                    onTap: () =>
                        ref.read(selectedDeliveryTypeProvider.notifier).state =
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: selectedDeliveryType?.id == 1
                            ? [
                                BoxShadow(
                                  color:
                                      const Color(0xFF3B4D8B).withOpacity(0.1),
                                  blurRadius: 5,
                                  offset: const Offset(0, 1),
                                ),
                              ]
            ...
            child: Row(
              children: [
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      ref.read(isOnlinePaymentProvider.notifier).state = true;
                    },
                    child: Container(
                      padding: const EdgeInsets.symmetric(
                        vertical: 12,
                      ...
                      decoration: BoxDecoration(
                        color:
                            isOnlinePayment ? Colors.white : Colors.transparent,
                        borderRadius: BorderRadius.circular(14),
                ...
                Expanded(
                  child: GestureDetector(
                    onTap: () {
                      ref.read(isOnlinePaymentProvider.notifier).state = false;
                    },
                    child: Container(
                      padding: const EdgeInsets.symmetric(
                        vertical: 12,
              ...
              children: [
                GestureDetector(
                  ...
                  child: Container(
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                      color: true ? AppColors.buttonSecondary : Colors.white,
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(
                        color:
                            true ? AppColors.primary : const Color(0xFFE0E0E0),
                        width: 1,
                      ),
                    ),
                    child: Row(
                ...
                GestureDetector(
                  ...
                  child: Container(
                    padding: const EdgeInsets.all(16),
                    decoration: BoxDecoration(
                      color: false ? AppColors.buttonSecondary : Colors.white,
                      borderRadius: BorderRadius.circular(8),
                      border: Border.all(
                        color:
                            false ? AppColors.primary : const Color(0xFFE0E0E0),
                        width: 1,
                      ),
                    ),
                    child: Row(
