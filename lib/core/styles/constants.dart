...
class AppLength {
  ...
  static const double details = 11.0;
...
class AppColors {
  // Primary colors
  static const Color primary = Color.fromRGBO(173, 39, 37, 1);
  ...
  static const Color backgroundSecondary = Color.fromRGBO(244, 246, 250, 1);
  // Button colors
